...
return (
    ...
    <div className="flex flex-col">
      ...
      <input
        ...
        value={formData.trust_registration_number}
        onChange={handleChange}
        disabled={disabled}
        onKeyDown={handleKeyDown}
        className={commonInputClass}
    ...
    <div className="flex flex-col">
      ...
      <input
        type="text"
        name="trust_pan_number"
        value={formData.trust_pan_number}
        onChange={handleChange}
        disabled={disabled}
        onKeyDown={handleKeyDown}
        className={commonInputClass}
    ...
    <FileInputWithPreview
      ...
      name="trust_pan_uploaded_url"
      onChange={handleFileChange}
      disabled={disabled}
      filePreview={filePreviews.trust_pan_uploaded_url}
      onDelete={() => handleFileDelete("trust_pan_uploaded_url")}
    />
    ...
    <div className="flex flex-col">
      ...
      <input
        type="text"
        name="trust_gstin_number"
        value={formData.trust_gstin_number}
        onChange={handleChange}
        disabled={disabled}
        onKeyDown={handleKeyDown}
        className={commonInputClass}
