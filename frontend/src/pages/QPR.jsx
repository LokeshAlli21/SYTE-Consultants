...
const [filters, setFilters] = useState({
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      setLoading(true);
      try {
        const data = await databaseService.getAllProjectsForQPR();
        console.log(data);
        setProjects(data);
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="  p-6 pt-0 mb-0">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-[#2F4C92] mb-2">QPR</h1>
              <p className="text-gray-500">Manage and monitor all your projects QPR </p>
            </div>
