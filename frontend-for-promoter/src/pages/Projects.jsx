...
<div className="mb-8">
      ...
      {/* Contact Information Card - Always show if userData has channelPartner */}
      {userData?.channelPartner && (
        <div className="bg-white/70 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/30 relative overflow-hidden">
          {/* Background Pattern */}
